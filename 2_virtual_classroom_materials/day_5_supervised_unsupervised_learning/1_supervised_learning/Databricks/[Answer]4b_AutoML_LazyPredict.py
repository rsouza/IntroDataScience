...
# MAGIC It supports regression as well as classification problems. 
# MAGIC
# MAGIC This library is a simple tool **without hyperparameter tuning**, but it can provide valueable insight, which type of algorithm works well for a given problem and is worth exploring further.
# MAGIC
