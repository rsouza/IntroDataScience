...
# MAGIC %md
# MAGIC **TO DO:** We will use the rbf kernel type ([`radial basis function`](https://en.wikipedia.org/wiki/Radial_basis_function_kernel)) for our model.
# MAGIC Instantiate a new
# MAGIC [`OneClassSVM`](https://scikit-learn.org/stable/modules/generated/sklearn.svm.OneClassSVM.html)
# MAGIC model as `svm` with kernel type 'rbf', a gamma value of 0.001 and a nu value of 0.03.
