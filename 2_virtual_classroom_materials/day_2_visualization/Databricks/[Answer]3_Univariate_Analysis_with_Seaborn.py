...
sns.displot(data=penguins, x="body_mass_g", height=6.5, aspect=1.3);
...
sns.displot(data=data, x="age", bins=25, height=6.5, aspect=1.3)
...
sns.displot(data=data, x="contact_duration", binwidth=0.5);
...
plt.figure(figsize=(13, 9))
sns.stripplot(data=data, x="contact_duration");
