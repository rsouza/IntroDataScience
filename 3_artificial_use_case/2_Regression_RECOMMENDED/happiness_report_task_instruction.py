...
# MAGIC %md
# MAGIC # <center> Regression Notebook <center>
# MAGIC 
# MAGIC In this task, we will work on some multivariable regression problems. The dataset we will be working on is a world happiness report from year `2015`, `2016`, `2017`, `2018`, and `2019`. It is a survey of the state of global happiness based on local economic production, social welfares, and etc.
# MAGIC 
...
# MAGIC We have 5 different files inside the ``Datasets`` folder prepared for you: `2015.csv`, `2016.csv`, `2017.csv`, `2018.csv`, `2019.csv`. The name of the file corresponds to the year of which this report is describing.
# MAGIC     
...
# MAGIC - merge all 5 files into one big dataframe (or numpy.array, list, no restrictions here)
