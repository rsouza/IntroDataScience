...
# MAGIC 
# MAGIC Can you modify the code in the editor below to computer ``the average rating of non-free apps``?
# MAGIC 
...
# MAGIC %md
# MAGIC ## 7. Combining Logical Operators
# MAGIC 
