...
# MAGIC Try to type this in the following cell: print(55 + 5) print(300 - 8) print(21 + 67)
...
# MAGIC %md
# MAGIC To raise a number to a power, we can use **. For example, to raise 2 to th power of 3:
