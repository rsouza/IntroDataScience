...
# MAGIC 2. Use the `freq_table()` function on the `app_rating list` (already generated from the previous task, task 1.6.6) to generate the frequency table for the `cont_rating` column. Store the table to a variable named `rating_ft`.
